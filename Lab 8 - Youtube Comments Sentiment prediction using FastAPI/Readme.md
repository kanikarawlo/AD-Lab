...
2.1 Create a Google Cloud Account if you don't have one.  
2.2 Go to Google Cloud Console → Click on Create a Project.  
2.3 Enable YouTube Data API v3 for your project.  
